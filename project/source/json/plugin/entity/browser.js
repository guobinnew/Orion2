...
(function ()
{
	...
	instanceProto.getDebuggerValues = function (propsections)
	{
		propsections.push({
			"title": "Browser",
			"properties": [
				{"name": "UA字符串", "value": navigator.userAgent, "readonly": true},
				{"name": "文档标题", "value": document.title, "readonly": true},
				{"name": "引用", "value": document.referrer, "readonly": true},
				{"name": "是否在线", "value": !!navigator.onLine, "readonly": true},
				{"name": "是否全屏", "value": !!(document["mozFullScreen"] || document["webkitIsFullScreen"] || document["fullScreen"] || this.runtime.isNodeFullscreen), "readonly": true},
				{"name": "当前URL", "value": window.location.toString(), "readonly": true},
				{"name": "协议", "value": window.location.protocol, "readonly": true},
				{"name": "域", "value": window.location.hostname, "readonly": true},
				{"name": "路径", "value": window.location.pathname, "readonly": true},
				{"name": "哈希值", "value": window.location.hash, "readonly": true},
				{"name": "查询字符串", "value": window.location.search, "readonly": true}
			]
		});
	};
	/**END-PREVIEWONLY**/
